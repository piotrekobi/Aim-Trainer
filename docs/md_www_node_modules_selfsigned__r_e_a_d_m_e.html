...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_selfsigned__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h2><a class="anchor" id="autotoc_md14765"></a>
Install</h2>
<div class="fragment"><div class="line">npm install selfsigned</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14766"></a>
Usage</h2>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md14767"></a>
Async</h4>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14768"></a>
Attributes</h2>
...
<h2><a class="anchor" id="autotoc_md14769"></a>
Options</h2>
...
<p >&zwj;You can avoid key pair generation specifying your own keys (&lsquo;{ keyPair: { publicKey: &rsquo;--&mdash;BEGIN PUBLIC KEY--&mdash;...', privateKey: '--&mdash;BEGIN RSA PRIVATE KEY--&mdash;...' }`) </p>
</blockquote>
<h3><a class="anchor" id="autotoc_md14770"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14771"></a>
License</h2>
<p >MIT </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
