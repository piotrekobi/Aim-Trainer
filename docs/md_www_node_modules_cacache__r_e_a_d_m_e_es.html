...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_cacache__r_e_a_d_m_e_es.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md3426"></a>
Instalación</h1>
...
<li>Usando el API en español</li>
<li>Leer<ul>
<li>`ls`</li>
<li>`ls.flujo`</li>
<li>`saca`</li>
<li>`saca.flujo`</li>
<li>`saca.info`</li>
<li>`saca.tieneDatos`</li>
</ul>
</li>
<li>Escribir<ul>
<li>`mete`</li>
<li>`mete.flujo`</li>
<li>opciones para `mete*`</li>
<li>`rm.todo`</li>
<li>`rm.entrada`</li>
<li>`rm.datos`</li>
</ul>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md3429"></a>
Características</h2>
<ul>
<li>Extracción por clave o por dirección de contenido (shasum, etc)</li>
<li>Usa el estándard de web, Subresource Integrity</li>
...
<p >Todos los participantes en este proyecto deben obedecer el <a class="el" href="sockjs-client_2_c_o_d_e___o_f___c_o_n_d_u_c_t_8md.html">Código de Conducta</a> (en inglés), y en general actuar de forma amable y respetuosa mientras participan en esta comunidad.</p>
<p >Por favor refiérase al <a class="el" href="md_www_node_modules_cacache__c_h_a_n_g_e_l_o_g.html">Historial de Cambios</a> (en inglés) para detalles sobre cambios importantes incluídos en cada versión.</p>
...
API</h2>
<h3><a class="anchor" id="autotoc_md3432"></a>
...
<p >Enumera todas las entradas en el caché, dentro de un solo objeto. Cada entrada en el objeto tendrá como clave la clave única usada para el índice, el valor siendo un objeto de `saca.info`.</p>
<h4><a class="anchor" id="autotoc_md3434"></a>
Ejemplo</h4>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3435"></a>
&lt;a name="ls-stream"&gt;&lt;/a&gt; &lt;tt&gt;&gt; cacache.ls.flujo(cache) -&gt; Readable&lt;/tt&gt;</h3>
<p >Enumera todas las entradas en el caché, emitiendo un objeto de `saca.info` por cada evento de <code>data</code> en el flujo.</p>
<h4><a class="anchor" id="autotoc_md3436"></a>
Ejemplo</h4>
...
<div class="line">  ...</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3437"></a>
...
<p ><code>integrity</code> es un <code>string</code> de Subresource Integrity. Dígase, un <code>string</code> que puede ser usado para verificar a la <code>data</code>, que tiene como formato <code>&lt;algoritmo&gt;-&lt;hacheo-integridad-base64&gt;</code>.</p>
...
<h4><a class="anchor" id="autotoc_md3438"></a>
Nota</h4>
<p >Esta función lee la entrada completa a la memoria antes de devolverla. Si estás almacenando datos Muy Grandes, es posible que `saca.flujo` sea una mejor solución.</p>
<h4><a class="anchor" id="autotoc_md3439"></a>
Ejemplo</h4>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3440"></a>
...
<h4><a class="anchor" id="autotoc_md3441"></a>
Ejemplo</h4>
<div class="fragment"><div class="line">// Busca por clave</div>
...
<div class="line">  fs.createWriteStream(&#39;./x.tgz&#39;)</div>
<div class="line">)</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3442"></a>
...
<h4><a class="anchor" id="autotoc_md3443"></a>
Campos</h4>
<ul>
<li><code>key</code> - Clave de la entrada. Igual al argumento <code>clave</code>.</li>
<li><code>integrity</code> - hacheo de Subresource Integrity del contenido al que se refiere esta entrada.</li>
...
<h4><a class="anchor" id="autotoc_md3444"></a>
Ejemplo</h4>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3445"></a>
&lt;a name="get-hasContent"&gt;&lt;/a&gt; &lt;tt&gt;&gt; cacache.saca.tieneDatos(cache, integrity) -&gt; Promise&lt;/tt&gt;</h3>
<p >Busca un hacheo Subresource Integrity en el caché. Si existe el contenido asociado con <code>integrity</code>, devuelve un objeto con dos campos: el hacheo <em>específico</em> que se usó para la búsqueda, <code>sri</code>, y el tamaño total del contenido, <code>size</code>. Si no existe ningún contenido asociado con <code>integrity</code>, devuelve <code>false</code>.</p>
<h4><a class="anchor" id="autotoc_md3446"></a>
Ejemplo</h4>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3447"></a>
&lt;a name="put-data"&gt;&lt;/a&gt; &lt;tt&gt;&gt; cacache.mete(cache, clave, datos, [ops]) -&gt; Promise&lt;/tt&gt;</h3>
<p >Inserta <code>datos</code> en el caché. El <code>Promise</code> devuelto se resuelve con un hacheo (generado conforme a `ops.algorithms`) después que la entrada haya sido escrita en completo.</p>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3449"></a>
...
<h4><a class="anchor" id="autotoc_md3450"></a>
Ejemplo</h4>
...
<div class="line">)</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3451"></a>
...
<h4><a class="anchor" id="autotoc_md3454"></a>
...
<h4><a class="anchor" id="autotoc_md3455"></a>
&lt;tt&gt;ops.algorithms&lt;/tt&gt;</h4>
<p >Por Defecto: &lsquo;['sha512&rsquo;]`</p>
<p >Algoritmos que se deben usar cuando se calcule el hacheo de subresource integrity para los datos insertados. Puede usar cualquier algoritmo enumerado en <code>crypto.getHashes()</code>.</p>
...
<h4><a class="anchor" id="autotoc_md3456"></a>
...
<h4><a class="anchor" id="autotoc_md3457"></a>
...
<h3><a class="anchor" id="autotoc_md3458"></a>
...
<h4><a class="anchor" id="autotoc_md3459"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3460"></a>
&lt;a name="rm-entry"&gt;&lt;/a&gt; &lt;tt&gt;&gt; cacache.rm.entrada(cache, clave) -&gt; Promise&lt;/tt&gt;</h3>
<p >Alias: <code>cacache.rm</code></p>
<p >Borra la entrada <code>clave</code> del índuce. El contenido asociado con esta entrada seguirá siendo accesible por hacheo usando `saca.flujo.porHacheo`.</p>
<p >Para borrar el contenido en sí, usa `rm.datos`. Si quieres hacer esto de manera más segura (pues ficheros de contenido pueden ser usados por multiples entradas), usa `verifica` para borrar huérfanos.</p>
<h4><a class="anchor" id="autotoc_md3461"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3462"></a>
...
<h4><a class="anchor" id="autotoc_md3463"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3464"></a>
...
<p ><em>Te interesa añadir más lenguajes? <a class="el" href="spdy-transport_2node__modules_2readable-stream_2_c_o_n_t_r_i_b_u_t_i_n_g_8md.html">Somete un PR</a>!</em></p>
<h3><a class="anchor" id="autotoc_md3465"></a>
...
<h3><a class="anchor" id="autotoc_md3466"></a>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3468"></a>
&lt;a name="with-tmp"&gt;&lt;/a&gt; &lt;tt&gt;&gt; tmp.conTmp(cache, ops, cb) -&gt; Promise&lt;/tt&gt;</h3>
<p >Crea un directorio temporero con `tmp.mkdir()` y ejecuta <code>cb</code> con él como primer argumento. El directorio creado será removido automáticamente cuando el valor devolvido por <code>cb()</code> se resuelva.</p>
<p >Las mismas advertencias aplican en cuanto a manejando permisos para los ficheros dentro del directorio.</p>
<h4><a class="anchor" id="autotoc_md3469"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3470"></a>
...
<h4><a class="anchor" id="autotoc_md3471"></a>
...
<h3><a class="anchor" id="autotoc_md3472"></a>
...
<h4><a class="anchor" id="autotoc_md3473"></a>
Opciones</h4>
<ul>
...
<h4><a class="anchor" id="autotoc_md3474"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md3475"></a>
...
<h4><a class="anchor" id="autotoc_md3476"></a>
Example</h4>
