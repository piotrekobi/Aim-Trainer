...
<title>Aim Trainer: Asynchronous work helpers</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_nan_doc_asyncworker.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">Asynchronous work helpers </div></div>
</div><!--header-->
<div class="contents">
...
<h2><a class="anchor" id="autotoc_md12674"></a>
Nan::AsyncWorker</h2>
...
<h2><a class="anchor" id="autotoc_md12675"></a>
...
<p >Previously the definition of <code><a class="el" href="namespace_nan.html#ac948aef827af63bb75c8949b11ae9586">Nan::AsyncProgressWorker</a></code> only allowed sending <code>const char</code> data. Now extending <code><a class="el" href="namespace_nan.html#ac948aef827af63bb75c8949b11ae9586">Nan::AsyncProgressWorker</a></code> will yield an instance of the implicit <code><a class="el" href="class_nan_1_1_async_progress_worker_base.html">Nan::AsyncProgressWorkerBase</a></code> template with type <code>&lt;char&gt;</code> for compatibility.</p>
<p ><code><a class="el" href="class_nan_1_1_async_progress_worker_base.html">Nan::AsyncProgressWorkerBase</a></code> &amp; <code><a class="el" href="namespace_nan.html#ac948aef827af63bb75c8949b11ae9586">Nan::AsyncProgressWorker</a></code> is intended for best-effort delivery of nonessential progress messages, e.g. a progress bar. The last event sent before the main thread is woken will be delivered.</p>
<p >Definition:</p>
<div class="fragment"><div class="line"> {c++}</div>
...
<h2><a class="anchor" id="autotoc_md12676"></a>
...
<p ><code><a class="el" href="class_nan_1_1_async_progress_queue_worker.html">Nan::AsyncProgressQueueWorker</a></code> behaves exactly the same as <code><a class="el" href="namespace_nan.html#ac948aef827af63bb75c8949b11ae9586">Nan::AsyncProgressWorker</a></code>, except all events are queued and delivered to the main thread.</p>
<p >Definition:</p>
<div class="fragment"><div class="line"> {c++}</div>
<div class="line">template&lt;class T&gt;</div>
