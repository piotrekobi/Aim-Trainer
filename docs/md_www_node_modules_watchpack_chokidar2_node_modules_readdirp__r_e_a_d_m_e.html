...
<title>Aim Trainer: readdirp &lt;a href=&quot;http://travis-ci.org/thlorenz/readdirp&quot; &gt;&lt;img src=&quot;https://secure.travis-ci.org/thlorenz/readdirp.svg&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_watchpack_chokidar2_node_modules_readdirp__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">readdirp <a href="http://travis-ci.org/thlorenz/readdirp"><img src="https://secure.travis-ci.org/thlorenz/readdirp.svg" alt="Build Status" style="pointer-events: none;" class="inline"/></a> </div></div>
</div><!--header-->
<div class="contents">
...
<li>More Examples<ul>
<li>stream api</li>
<li>stream api pipe</li>
<li>grep</li>
<li>using callback api</li>
<li><a class="el" href="md_www_node_modules_nan__r_e_a_d_m_e.html#tests">tests</a></li>
</ul>
</li>
</ul>
<h1><a class="anchor" id="autotoc_md17762"></a>
Installation</h1>
<pre class="fragment">npm install readdirp
</pre> <h1><a class="anchor" id="autotoc_md17763"></a>
API</h1>
<p ><em><b>var entryStream = readdirp (options)</b></em></p>
<p >Reads given root recursively and returns a <code>stream</code> of entry infos.</p>
<h2><a class="anchor" id="autotoc_md17764"></a>
entry stream</h2>
...
<h2><a class="anchor" id="autotoc_md17765"></a>
options</h2>
<ul>
<li><b>root</b>: path in which to start reading and recursing into subdirectories</li>
<li><b>fileFilter</b>: filter to include/exclude files found (see Filters for more)</li>
<li><b>directoryFilter</b>: filter to include/exclude directories found and to recurse into (see Filters for more)</li>
...
<h2><a class="anchor" id="autotoc_md17766"></a>
entry info</h2>
...
<h2><a class="anchor" id="autotoc_md17767"></a>
Filters</h2>
...
<h2><a class="anchor" id="autotoc_md17768"></a>
Callback API</h2>
...
<h3><a class="anchor" id="autotoc_md17769"></a>
allProcessed</h3>
<ul>
...
<li><b>res</b>: collection of file/directory entry infos</li>
</ul>
<h3><a class="anchor" id="autotoc_md17770"></a>
fileProcessed</h3>
<ul>
<li>function with entry info parameter e.g., <code>function (entryInfo) { ... }</code></li>
</ul>
<h1><a class="anchor" id="autotoc_md17771"></a>
More Examples</h1>
...
<h2><a class="anchor" id="autotoc_md17772"></a>
tests</h2>
