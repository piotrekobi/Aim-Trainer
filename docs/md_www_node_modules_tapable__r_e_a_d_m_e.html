...
<title>Aim Trainer: Tapable</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_tapable__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">Tapable </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p >The tapable packages exposes many Hook classes, which can be used to create hooks for plugins.</p>
...
<div class="line">            break: new SyncHook(),</div>
...
<div class="line">myCar.hooks.break.tap(&quot;WarningLampPlugin&quot;, () =&gt; warningLamp.on());</div>
...
<h1><a class="anchor" id="autotoc_md16450"></a>
Interception</h1>
...
<div class="line">    },</div>
<div class="line">    tap: (tapInfo) =&gt; {</div>
...
<h1><a class="anchor" id="autotoc_md16451"></a>
HookMap</h1>
...
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md16452"></a>
...
<div class="line">    for: (key: any) =&gt; Hook</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md16453"></a>
MultiHook</h1>
