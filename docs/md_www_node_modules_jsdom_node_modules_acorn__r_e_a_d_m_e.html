...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_jsdom_node_modules_acorn__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">Acorn </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p >A tiny, fast JavaScript parser written in JavaScript.</p>
<h1><a class="anchor" id="autotoc_md11726"></a>
Community</h1>
...
<h1><a class="anchor" id="autotoc_md11727"></a>
Installation</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md11728"></a>
Interface</h1>
...
<ul>
<li><p class="startli"><b>ecmaVersion</b>: Indicates the ECMAScript version to parse. Must be either 3, 5, 6 (or 2015), 7 (2016), 8 (2017), 9 (2018), 10 (2019), 11 (2020), 12 (2021), 13 (2022, partial support) or <code>"latest"</code> (the latest the library supports). This influences support for strict mode, the set of reserved words, and support for new syntax features.</p>
...
<div class="line">}</div>
</div><!-- fragment --><p class="startli">Note that you are not allowed to call the parser from the callback—that will corrupt its internal state.</p>
</li>
...
<h1><a class="anchor" id="autotoc_md11730"></a>
...
<h1><a class="anchor" id="autotoc_md11731"></a>
Existing plugins</h1>
<ul>
