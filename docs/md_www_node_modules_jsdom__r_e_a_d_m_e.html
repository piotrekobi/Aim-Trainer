...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_jsdom__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><h1 align="center"><img src="logo.svg" alt="" style="pointer-events: none;" width="100" height="100" class="inline"/><br  />
 jsdom </h1>
...
<p >The latest versions of jsdom require Node.js v12 or newer. (Versions of jsdom below v17 still work with previous Node.js versions, but are unsupported.)</p>
...
<h3><a class="anchor" id="autotoc_md11758"></a>
Simple options</h3>
...
<h3><a class="anchor" id="autotoc_md11759"></a>
...
<p >If you want to execute <em>external</em> scripts, included via <code>&lt;script src=""&gt;</code>, you'll also need to ensure that they load them. To do this, add the option <code>resources: "usable"</code> as described below. (You'll likely also want to set the <code>url</code> option, for the reasons discussed there.)</p>
...
<h3><a class="anchor" id="autotoc_md11760"></a>
...
<div class="line">});</div>
</div><!-- fragment --><p >Note that jsdom still does not do any layout or rendering, so this is really just about <em>pretending</em> to be visual, not about implementing the parts of the platform a real, visual web browser would implement.</p>
<h3><a class="anchor" id="autotoc_md11761"></a>
Loading subresources</h3>
<h4><a class="anchor" id="autotoc_md11762"></a>
Basic options</h4>
...
<p >When attempting to load resources, recall that the default value for the <code>url</code> option is <code>"about:blank"</code>, which means that any resources included via relative URLs will fail to load. (The result of trying to parse the URL <code>/something</code> against the URL <code>about:blank</code> is an error.) So, you'll likely want to set a non-default value for the <code>url</code> option in those cases, or use one of the convenience APIs that do so automatically.</p>
<h4><a class="anchor" id="autotoc_md11763"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11764"></a>
Virtual consoles</h3>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11765"></a>
Cookie jars</h3>
...
<h3><a class="anchor" id="autotoc_md11766"></a>
...
<h2><a class="anchor" id="autotoc_md11767"></a>
...
<h3><a class="anchor" id="autotoc_md11768"></a>
Properties</h3>
...
<h3><a class="anchor" id="autotoc_md11769"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11770"></a>
...
<h3><a class="anchor" id="autotoc_md11771"></a>
...
<div class="fragment"><div class="line">const { Script } = require(&quot;vm&quot;);</div>
<div class="line"> </div>
<div class="line">const dom = new JSDOM(``, { runScripts: &quot;outside-only&quot; });</div>
<div class="line">const script = new Script(`</div>
<div class="line">  if (!this.ran) {</div>
<div class="line">    this.ran = 0;</div>
<div class="line">  }</div>
<div class="line"> </div>
<div class="line">  ++this.ran;</div>
<div class="line">`);</div>
<div class="line"> </div>
<div class="line">const vmContext = dom.getInternalVMContext();</div>
<div class="line"> </div>
<div class="line">script.runInContext(vmContext);</div>
<div class="line">script.runInContext(vmContext);</div>
<div class="line">script.runInContext(vmContext);</div>
<div class="line"> </div>
<div class="line">console.assert(dom.window.ran === 3);</div>
</div><!-- fragment --><p >This is somewhat-advanced functionality, and we advise sticking to normal DOM APIs (such as <code>window.eval()</code> or <code>document.createElement("script")</code>) unless you have very specific needs.</p>
<p >Note that this method will throw an exception if the <code>JSDOM</code> instance was created without <code>runScripts</code> set, or if you are using jsdom in a web browser.</p>
<h3><a class="anchor" id="autotoc_md11772"></a>
...
<h2><a class="anchor" id="autotoc_md11773"></a>
Convenience APIs</h2>
<h3><a class="anchor" id="autotoc_md11774"></a>
&lt;tt&gt;fromURL()&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md11775"></a>
&lt;tt&gt;fromFile()&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md11776"></a>
&lt;tt&gt;fragment()&lt;/tt&gt;</h3>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11777"></a>
Other noteworthy features</h2>
<h3><a class="anchor" id="autotoc_md11778"></a>
Canvas support</h3>
...
<h3><a class="anchor" id="autotoc_md11779"></a>
...
<h3><a class="anchor" id="autotoc_md11780"></a>
...
<h3><a class="anchor" id="autotoc_md11781"></a>
...
<h3><a class="anchor" id="autotoc_md11782"></a>
...
<h3><a class="anchor" id="autotoc_md11785"></a>
