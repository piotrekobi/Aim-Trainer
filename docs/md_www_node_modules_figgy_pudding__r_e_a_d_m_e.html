...
<title>Aim Trainer: Note: pending imminent deprecation</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('md_www_node_modules_figgy_pudding__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">Note: pending imminent deprecation </div></div>
</div><!--header-->
<div class="contents">
...
<h3><a class="anchor" id="autotoc_md6339"></a>
The God Object is Dead!</h3>
<h3><a class="anchor" id="autotoc_md6340"></a>
Now Bring Us Some Figgy Pudding!</h3>
<h2><a class="anchor" id="autotoc_md6341"></a>
Install</h2>
<p ><code>$ npm install figgy-pudding</code></p>
<h2><a class="anchor" id="autotoc_md6342"></a>
...
<li>`figgyPudding(spec)`</li>
<li>`PuddingFactory(values)`<ul>
<li>`opts.get()`</li>
<li>`opts.concat()`</li>
<li>`opts.toJSON()`</li>
<li>`opts.forEach()`</li>
<li>`opts[Symbol.iterator]()`</li>
<li>`opts.entries()`</li>
<li>`opts.keys()`</li>
<li>`opts.value()`</li>
</ul>
...
<h3><a class="anchor" id="autotoc_md6343"></a>
Example</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md6344"></a>
Features</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md6345"></a>
API</h3>
<h4><a class="anchor" id="autotoc_md6346"></a>
...
<p ><a class="anchor" id="autotoc_md6347"></a> </p><h5>Example</h5>
...
<div class="line">  cache: {}</div>
<div class="line">})</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6348"></a>
...
<p ><a class="anchor" id="autotoc_md6349"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6350"></a>
&lt;a name="opts-get"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.get(key) -&gt; Value&lt;/tt&gt;</h4>
<p >Gets a value from the options object.</p>
<p ><a class="anchor" id="autotoc_md6351"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6352"></a>
...
<p ><a class="anchor" id="autotoc_md6353"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6354"></a>
...
<p ><a class="anchor" id="autotoc_md6355"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1})</div>
<div class="line">opts.toJSON() // {x: 1}</div>
<div class="line">JSON.stringify(opts) // &#39;{&quot;x&quot;:1}&#39;</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6356"></a>
...
<p ><a class="anchor" id="autotoc_md6357"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6358"></a>
...
<p ><a class="anchor" id="autotoc_md6359"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
<div class="line">[...opts({x: 1, y: 2}).entries()] // [[&#39;x&#39;, 1], [&#39;y&#39;, 2]]</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6360"></a>
...
<p ><a class="anchor" id="autotoc_md6361"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
...
<div class="line">}</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6362"></a>
...
<p ><a class="anchor" id="autotoc_md6363"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
<div class="line">[...opts({x: 1, y: 2}).keys()] // [&#39;x&#39;, &#39;y&#39;]</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md6364"></a>
...
<p ><a class="anchor" id="autotoc_md6365"></a> </p><h5>Example</h5>
